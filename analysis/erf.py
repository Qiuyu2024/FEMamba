...
root_path = '../options/test/test_FEMamba_lightSR_x2.yml'
...
if __name__ == '__main__':
    ...
    ckpt_path = '//root/FEMamba/experiments/MambaIR_lightSR_x4_pre/models/net_g_470000.pth' # path to load your pre_trained model weights
